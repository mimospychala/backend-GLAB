...
export default function DetailCard({ product }) {
    ...
    const [isCommentClicked, setIsCommetClicked] = useState(false)
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.itemContainer}>
                        ...
                        <div className={styles.comentShare}>
                            <LikeButton />
                            <CommentButton func={(e) => setIsCommetClicked(!isCommentClicked)} />
                            <ShareButton />
                        </div>
                        {isCommentClicked && <Comments id={product.id} func={(e) => setIsCommetClicked(!isCommentClicked)} />}
